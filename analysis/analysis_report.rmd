...
```{r Prepare data for repetition priming analysis}
exptdata <- exptdata %>%
...
```{r Repetition Priming Statistics} 
capture_singleton_repetition.ANOVA <- aov_car(capture ~ singleton_repetition*condition*dType + Error(sub/singleton_repetition*dType), data = saccadeData_means_bysingletonrepetition, anova_table = list(es="pes"))
...
```{r Contingency belief score data prep}
awaredata <- awaredata %>%
...
```{r Reward contingency belief data}
...
```{r Omission contingency belief data}
